	...
	return (
		<div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
				...
				<div className="flex-grow ml-4 p-4 rounded-lg bg-pink-200">
					...
					<div className="py-2 w-full">
						...
						<p className="font-medium text-gray-700 italic">
							...
							100s were scored in 2nd innings of the game.
						</p>
					</div>
				</div>
			</div>
			...
			<div className="flex relative pb-12">
				...
				<div className="flex-grow ml-4 p-4 rounded-lg bg-pink-200">
					<h2 className="font-medium title-font text-lg text-gray-700 mb-1 tracking-wider">
						Stronger the opponent, more strong is the Sachin
					</h2>
					<div className="py-2 w-full">
						<h2 className="title-font font-bold font-serif text-4xl text-blue-700">
							{ausStat.runs}
						...
						<p className="font-medium text-gray-700 italic">
							...
							ODIs, which clearly shows his class against even
							bigger teams.
						</p>
					</div>
				</div>
			...
			<div className="flex relative pb-12">
				...
				<div className="flex-grow ml-4 p-4 rounded-lg bg-orange-200">
					...
					<div className="py-2 w-full">
						...
						<p className="font-medium text-gray-700 italic">
							Being a top-order batsman, Sachin proved to be a
							trickster too. He took{" "}
							<span className="text-indigo-500 font-bold">
								{wickets}
							</span>{" "}
							wickets in his entire ODI career, breaking crucial
							partnerships and hence winning a match for India.
						</p>
					</div>
				</div>
			</div>
